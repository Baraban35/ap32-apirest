...
INSERT INTO Bloc (ref, refSpe, intitule) VALUES 
('B1','C','Support et mise à disposition des services informatiques'),
('B2','A','Administration des systèmes et des réseaux'),
('B2','B','Conception et développement d\'applications'),
('B3','A','Cybersécurité des services informatiques'),
('B3','B','Cybersécurité des services informatiques'),
('B3','C','Cybersécurité des services informatiques');


INSERT INTO Competence (refBloc, numeroOrdre, refSpe,libelle) VALUES
('B1',1,'C','Gérer le patrimoine informatique'),
('B1',2,'C','Répondre aux incidents et aux demandes d’assistance et d’évolution'),
('B1',3,'C','Développer la présence en ligne de l’organisation'),
('B1',4,'C','Travailler en mode projet'),
('B1',5,'C','Mettre à disposition des utilisateurs un service informatique (orienté utilisateurs)'),
('B1',6,'C','Organiser son développement professionnel'),
('B2',1,'A','Concevoir une solution d\'infrastructure réseau'),
('B2',2,'A','Installer, tester et déployer une solution d\'infrastructure réseau'),
('B2',3,'A','Exploiter, dépanner et superviser une solution d\'infrastructure réseau'),
('B2',1,'B','Concevoir et développer une solution applicative'),
('B2',2,'B','Assurer la maintenance corrective ou évolutive d\'une solution applicative'),
('B2',3,'B','Gérer les données'),
('B3',1,'C','Protéger les données à caractère personnel'),
('B3',2,'C','Préserver l\'identité numérique de l’organisation'),
('B3',3,'C','Sécuriser les équipements et les usages des utilisateurs'),
('B3',4,'C','Garantir la disponibilité, l\'intégrité et la confidentialité des services informatiques et des données de l’organisation face aux cyberattaques'),
('B3',5,'A','Assurer la cybersécurité d\'une infrastructure réseau'),
('B3',5,'B','Assurer la cybersécurité d\'une solution applicative et de son développement');
...
INSERT INTO Etudiant (numero, nom, prenom, adresse, codePostal, ville, email, mdp, anneePromo, refSpe) VALUES
(1, 'Bitauld', 'Nicolas', '', '', '', 'Nicolas.Bitauld@gmail.com', 'passe', 2022, 'B'),
(2, 'Busson', 'Jeremie', '', '', '', 'Jeremie.Busson@gmail.com', 'passe', 2022, 'A'),
(3, 'Cormier', 'Freddy', '', '', '', 'Freddy.Cormier@gmail.com', 'passe', 2022, 'A'),
(4, 'Duval', 'François', '', '', '', 'Francois.Duval@gmail.com', 'passe', 2022, 'B'),
(5, 'Fevrier', 'Pierre', '', '', '', 'Pierre.Fevrier@gmail.com', 'passe', 2022, 'A'),
(6, 'Guyonvarh', 'Romain', '', '', '', 'Romain.Guyonvarh@gmail.com', 'passe', 2022, 'A'),
(7, 'Lagueux', 'Sylvain', '', '', '', 'Sylvain.Lagueux@gmail.com', 'passe', 2022, 'B'),
(8, 'Lallican', 'Benoit', '', '', '', 'Benoit.Lallican@gmail.com', 'passe', 2022, 'A'),
(9, 'Laurent', 'Yannick', '', '', '', 'Yannick.Laurent@gmail.com', 'passe', 2022, 'A'),
(10, 'Le Joly', 'Sylvain', '', '', '', 'Sylvain.LeJoly@gmail.com', 'passe', 2022, 'A'),
(11, 'Le Quer', 'Mathieu', '', '', '', 'Mathieu.LeQuer@gmail.com', 'passe', 2022, 'A'),
(12, 'Le Thomas', 'Julie', '', '', '', 'Julie.Nguyen@gmail.com', 'passe', 2022, 'B'),
(13, 'Malescot', 'Damien', '', '', '', 'Damien.Malescot@gmail.com', 'passe', 2022, 'A'),
(14, 'Pagan', 'Anne', '', '', '', 'Anne.Pagan@gmail.com', 'passe', 2022, 'B'),
(15, 'Philouze', 'Pierre', '', '', '', 'Pierre.Philouze@gmail.com', 'passe', 2022, 'A'),
(16, 'Repillez', 'Gael', '', '', '', 'Gael.Repillez@gmail.com', 'passe', 2022, 'B'),
(17, 'Ripoll', 'Mathias', '', '', '', 'Mathias.Ripoll@gmail.com', 'passe', 2022, 'B'),
(18, 'Trehen', 'Alban', '', '', '', 'Alban.Trehen@gmail.com', 'passe', 2022, 'A'),
(19, 'Ya', 'Long', '', '', '', 'Long.Ya@gmail.com', 'passe', 2022, 'A'),
(20, 'Besnier', 'Antoine', '', '', '', 'Antoine.Besnier@gmail.com', 'passe', 2022, 'B'),
(21, 'Bâcle', 'Amelie', '', '', '', 'Amelie.Bacle@gmail.com', 'passe', 2022, 'A'),
(22, 'Bazire', 'Antony', '', '', '', 'Antony.Bazire@gmail.com', 'passe', 2022, 'A'),
(23, 'Benoist', 'Florent', '', '', '', 'Florent.Benoist@gmail.com', 'passe', 2022, 'B'),
(24, 'Boudjema', 'Hiba', '', '', '', 'Hiba.Boudjema@gmail.com', 'passe', 2022, 'B'),
(25, 'Boullier', 'Ludovic', '', '', '', 'Ludovic.Boullier@gmail.com', 'passe', 2022, 'B'),
(26, 'Brouillat', 'Sylvain', '', '', '', 'Sylvain.Brouillat@gmail.com', 'passe', 2022, 'A'),
(27, 'Caillat', 'Xavier', '', '', '', 'Xavier.Caillat@gmail.com', 'passe', 2022, 'A'),
(28, 'Charuel', 'Olivier', '', '', '', 'Olivier.Charuel@gmail.com', 'passe', 2022, 'A'),
(29, 'Doulin', 'Jean-François', '', '', '', 'Jean-François.Doulin@gmail.com', 'passe', 2022, 'A'),
(30, 'Fourmond', 'Jeremy', '', '', '', 'Jeremy.Fourmond@gmail.com', 'passe', 2022, 'A'),
(31, 'Heliès', 'Jerôme', '', '', '', 'Jerôme.Heliès@gmail.com', 'passe', 2022, 'A'),
(32, 'Hilpron', 'Typhaine', '', '', '', 'Typhaine.Hilpron@gmail.com', 'passe', 2022, 'A'),
(33, 'Giron', 'Nicolas', '', '', '', 'Nicolas.Giron@gmail.com', 'passe', 2022, 'A'),
(34, 'Lambert', 'Samuel', '', '', '', 'Samuel.Lambert@gmail.com', 'passe', 2022, 'A'),
(35, 'Jean', 'Pierre', '', '', '', 'Pierre.Jean@gmail.com', 'passe', 2022, 'A'),
(36, 'Latorre', 'Jeremy', '', '', '', 'Jeremy.Latorre@gmail.com', 'passe', 2022, 'A'),
(37, 'Le Meur', 'Raphael', '', '', '', 'Raphael.Le Meur@gmail.com', 'passe', 2022, 'A'),
(38, 'Le Voguer', 'Yannick', '', '', '', 'Yannick.Le Voguer@gmail.com', 'passe', 2022, 'A'),
(39, 'Leroy', 'Charly', '', '', '', 'Charly.Leroy@gmail.com', 'passe', 2022, 'A'),
(40, 'Lolom', 'Axel', '', '', '', 'Axel.Lolom@gmail.com', 'passe', 2022, 'A'),
(41, 'Ouin', 'Quentin', '', '', '', 'Quentin.Ouin@gmail.com', 'passe', 2022, 'A'),
(42, 'Robichet', 'François', '', '', '', 'François.Robichet@gmail.com', 'passe', 2022, 'A'),
(43, 'Tanguy', 'Antoine', '', '', '', 'Antoine.Tanguy@gmail.com', 'passe', 2022, 'A'),
(44, 'Trouchard', 'Romain', '', '', '', 'Romain.Trouchard@gmail.com', 'passe', 2022, 'A');
