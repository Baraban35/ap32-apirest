...
<div id="container">
	...
	<div id="body">
		<p>Exemples d'appels des web services sur la base de données</p>
		
		<ul>
            <li><a href="<?= site_url('organisations');?>">Organisations</a></li> 
            <li><a href="<?= site_url('organisations/25');?>">L'organisation numéro 25</a></li> 
            <li><a href="<?= site_url('organisations/25/contacts');?>">Les contacts de l'organisation numéro 25</a></li> 
            <li><a href="<?= site_url('organisations/25/contacts/1');?>">Le contact d'identifiant 1 de l'organisation numéro 25</a></li> 
            <li><a href="<?= site_url('stages');?>">Stages</a></li> 
            <li><a href="<?= site_url('stages/1');?>">Le stage d'identifiant 1 </a></li> 			
		</ul>
